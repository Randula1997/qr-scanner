...
import {Text, View, Image, SafeAreaView, ActivityIndicator, FlatList, TouchableOpacity} from 'react-native';
...
const Home = ({navigation}) => {
  ...
  return (
    ...
    <HomeModal navigation={navigation} modalVisible={modalVisible} setModalVisible={setModalVisible}/>
